...
class Pipeline_designer(QtWidgets.QWidget):
    ...
    def retranslateUi(self):
        ...
        self.label.setText(_translate("Pipeline_designer", "TextLabel"))
        self.radioButton.setText(_translate("Pipeline_designer", "RadioButton"))
        self.listWidget.setSortingEnabled(True)
        __sortingEnabled = self.listWidget.isSortingEnabled()
        self.listWidget.setSortingEnabled(False)
        item = self.listWidget.item(0)
        item.setText(_translate("Pipeline_designer", "New Item"))
        self.listWidget.setSortingEnabled(__sortingEnabled)
        item = self.tableWidget.verticalHeaderItem(0)
        item.setText(_translate("Pipeline_designer", "New Row"))
        item = self.tableWidget.verticalHeaderItem(1)
        item.setText(_translate("Pipeline_designer", "New Row"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Pipeline_designer", "New Column"))
        self.pushButton.setText(_translate("Pipeline_designer", "Save"))
        self.label_2.setText(_translate("Pipeline_designer", "Reference version:"))
        self.Pipeline_name.setText(_translate("Pipeline_designer", "Pipeline:"))
        self.pushButton_3.setText(_translate("Pipeline_designer", "Cancel"))
        self.pushButton_2.setText(_translate("Pipeline_designer", "Reset"))
        ...
        self.treeWidget.topLevelItem(3).child(0).setText(0, _translate("Pipeline_designer", "SNV & short InDels"))
        self.treeWidget.topLevelItem(3).child(1).setText(0, _translate("Pipeline_designer", "Copy Number Variation"))
        ...
        self.treeWidget.topLevelItem(5).child(0).setText(0, _translate("Pipeline_designer", "SNV & short InDels"))
        self.treeWidget.topLevelItem(5).child(1).setText(0, _translate("Pipeline_designer", "Copy Number Variation"))
