...
class Ui_Analysis_page(object):
    def setupUi(self, Analysis_page):
        ...
        self.checkBox = QtWidgets.QCheckBox(self.frame_21)
    ...
    def retranslateUi(self, Analysis_page):
        ...
        self.checkBox.setText(_translate("Analysis_page", "Use parallel analysis"))
        self.checkBox_2.setText(_translate("Analysis_page", "Delete temp files"))
