...
class Experiment_builder(QtWidgets.QWidget):
    ...
    def get_Transcriptlist(self):
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        file, _ = QFileDialog.getOpenFileName(self,"Choose Transcript list file", self.configs_folder, options=options)
        if file:
    ...
    def save_Experiment(self):
        ...
        if ret == QMessageBox.Save:
            ...
            if experiment != "" and experiment != "select Experiment":
                ...
                with open(self.configs_folder + '/experiment_list.cfg', 'w') as cfg:
    ...
    def delete_Experiment(self):
        ...
        if ret == QMessageBox.Yes:
            ...
            with open(os.path.dirname(self.configs_folder+'/experiment_list.cfg', 'w')) as cfg:
                    json.dump(self.experiment_config, cfg, indent=4)
    ...
    def get_config(self):
        return json.loads((open(self.configs_folder+'/experiment_list.cfg').read()).encode('utf8'))
