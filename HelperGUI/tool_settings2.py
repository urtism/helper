...
class Ui_tool_settings(object):
    def setupUi(self, tool_settings):
        ...
        self.retranslateUi(tool_settings)
        QtCore.QMetaObject.connectSlotsByName(tool_settings)

    def retranslateUi(self, tool_settings):
        _translate = QtCore.QCoreApplication.translate
        tool_settings.setWindowTitle(_translate("tool_settings", "Analysis Settings"))
        ...
        self.groupBox_2.setTitle(_translate("tool_settings", "Settings"))
        item = self.tableWidget.verticalHeaderItem(0)
        item.setText(_translate("tool_settings", "aasdasd"))
        item = self.tableWidget.verticalHeaderItem(1)
        item.setText(_translate("tool_settings", "New Row"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("tool_settings", "New Column"))
        __sortingEnabled = self.tableWidget.isSortingEnabled()
        self.tableWidget.setSortingEnabled(False)
        item = self.tableWidget.item(0, 0)
        item.setText(_translate("tool_settings", "ciaoassssssssssssssssssssssssssssssssssssssssssssssssssssssss"))
        self.tableWidget.setSortingEnabled(__sortingEnabled)
        self.changeSetting_pushButton.setText(_translate("tool_settings", "Change settings"))
